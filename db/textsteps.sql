insert into steps(number, type, template, data) values
(
1,
'text copy',
...
'text copy',
'step_copytext.tmpl.html',
'Escaped alpaca interrupts soccer game in England

An alpaca escaped from a farm in Britain and traveled to a local soccer field, where it interrupted a game just before halftime.
